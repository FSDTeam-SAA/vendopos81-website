...
const slides = [
  {
    ...
    accentColor: "#3BB77E",
    bgPattern: "bg-[radial-gradient(circle_at_30%_50%,rgba(59,183,126,0.1)_0%,transparent_50%)]",
  },
  {
    ...
    image: "/images/bannerimage.png",
    accentColor: "#F74B81",
    bgPattern: "bg-[radial-gradient(circle_at_30%_50%,rgba(247,75,129,0.1)_0%,transparent_50%)]",
  },
  {
    ...
    image: "/images/bannerimage.png",
    accentColor: "#FFB74D",
    bgPattern: "bg-[radial-gradient(circle_at_30%_50%,rgba(255,183,77,0.1)_0%,transparent_50%)]",
  },
]
        ...
        {slides.map((_, i) => (
          ...
          >
            <div className={`h-1.5 rounded-full transition-all duration-500 ${
              i === index ? "w-12 bg-primary" : "w-4 bg-gray-300 group-hover:bg-gray-400"
            }`} />
          </button>
        ))}
      </div>
